...
<div class="w3-top">
    <div class="w3-bar w3-theme-d2 w3-left-align w3-large">
        ...
        <div class="w3-dropdown-hover w3-hide-small w3-padding-large w3-right w3-hover-white">
            <a href="index.html" class="w3-bar-item w3-button w3-hover-white" title="My Account">
            ...
            <div class="w3-dropdown-content w3-card-4 w3-bar-block" style="width:300px">
                ...
                <c:if test="${sessionScope.user!=null}">
                    ...
                    <a href="/trellos?action=signin" class="w3-bar-item w3-button">Sign out</a>
                </c:if>
            </div>
        </div>
        <%--        <a href="index.html" class="w3-bar-item w3-button w3-hide-small w3-right w3-padding-large w3-hover-white" title="My Account">--%>
    ...
    <div class="w3-row">
        ...
        <div class="w3-col m7">
            ...
            <div class="w3-container w3-card w3-white w3-round w3-margin"><br>
                <img src="https://i.pinimg.com/originals/2b/09/11/2b09115a77cd3d55ea773c40c0018289.jpg" alt="Avatar"
                ...
                <div class="w3-row-padding" style="margin:0 -16px">
                    <div class="w3-half">
                        <img src="https://touristjourney.com/wp-content/uploads/2020/07/How-to-See-the-Northern-Lights-in-Iceland-scaled.jpg"
                             style="width:20rem;height: 16rem" alt="Northern Lights" class="w3-margin-bottom">
                    </div>
                    <div class="w3-half">
                        <img src="https://images.lanouvellerepublique.fr/image/upload/t_1020w/628642fc1feac1cb308b456f.jpg"
                             style="width:20rem;height: 16rem" alt="Nature" class="w3-margin-bottom">
                    </div>
                </div>
            ...
            <div class="w3-container w3-card w3-white w3-round w3-margin"><br>
                <img src="https://i.pinimg.com/736x/d4/1c/e6/d41ce64d50c3e3a49884b05fa41dc3b5.jpg" alt="Avatar"
                     class="w3-left w3-circle w3-margin-right" style="width:60px">
            ...
            <div class="w3-container w3-card w3-white w3-round w3-margin"><br>
                <img src="https://toigingiuvedep.vn/wp-content/uploads/2021/05/hinh-anh-avatar-de-thuong.jpg"
                     alt="Avatar" class="w3-left w3-circle w3-margin-right" style="width:60px">
                <span class="w3-right w3-opacity">32 min</span>
                <h4>Angie Jane</h4><br>
                <hr class="w3-clear">
                <p>Have you seen this?</p>
                <img src="https://i.natgeofe.com/n/bfec083e-ac57-4c17-8af1-3e8b322df8e0/NGM%20Ballesta%20Underwater-1.jpg"
        ...
        <div class="w3-col m2">
            <div class="w3-card w3-round w3-white w3-center">
                <div class="w3-container">
                    <p>Upcoming Events:</p>
                    <img src="https://cdn.pixabay.com/photo/2016/11/29/07/12/forest-1868028_640.jpg" alt="Forest"
                         style="width:100%;">
            ...
            <div class="w3-card w3-round w3-white w3-center">
                <div class="w3-container">
                    <p>Friend Request</p>
                    <img src="https://thao68.com/wp-content/uploads/2022/03/avatar-tiktok-20.jpg" alt="Avatar"
                         style="width:50%"><br>
                    <span>Jane Doe</span>
